...
def config_andermatt_zuerich_pr_trends_off() -> BiasCorrectionConfig:
    ...
    return BiasCorrectionConfig(
        ...
        file_path_bc_data=repo_root / "output_data" / "andermatt_zuerich_1981_2019" / "trends_off" / "gridded" / "pr_bc_andermatt_zuerich_1981_2019.nc",
        file_path_figures=repo_root / "output_data" / "andermatt_zuerich_1981_2019" / "trends_off" / "figures",
    )
