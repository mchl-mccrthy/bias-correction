function [station_clim_var,station_coords,station_lat,station_lon,station_time,n_stations] = loadstationdata(file_path_station_clim_var,file_path_station_coords)
