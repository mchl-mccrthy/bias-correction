...
function clim_data_retrended = retrendclimdata(clim_data, trends, bc_type, multiplicative_epsilon)

% Remove trends
if strcmp(bc_type,'additive')
    clim_data_retrended = clim_data+trends;
else
    clim_data_retrended = clim_data.*(trends+multiplicative_epsilon)-multiplicative_epsilon;
