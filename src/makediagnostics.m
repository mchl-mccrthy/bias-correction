...
% Load raw data
[raw_grid_clim_var,raw_lon,raw_lat,raw_time] = loadrawdata( ...
...
diagnostics.station_lon = station_lon;
...
diagnostics.raw_lon = raw_lon;
diagnostics.raw_lat = raw_lat;
diagnostics.raw_time = raw_time;
