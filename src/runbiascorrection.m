...
results.bc_clim_var = bc_clim_var;
results.raw_lon = raw_lon;
results.raw_lat = raw_lat;
results.raw_time = raw_time;
results.station_clim_var = station_clim_var;
results.station_coords = station_coords;
results.station_time = station_time;
results.raw_clim_var_station = raw_clim_var_station;
results.bc_clim_var_station = bc_clim_var_station;
results.station_trends = station_trends;
results.raw_trends = raw_trends;
results.bc_trends = bc_trends;
