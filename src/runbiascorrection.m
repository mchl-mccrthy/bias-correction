...
[raw_grid_clim_var,grid_x,grid_y,raw_time]...
    = loadrawdata(...
...
if keep_grid_biases
    [bc_grid_clim_var,grid_biases]...
        = mapquantiles(...
        raw_grid_clim_var,station_x,station_y,qmfs,grid_x,grid_y,...
...
if preserve_trends  
    station_grid_trends...
        = interptrends(...
        station_trends,station_x,station_y,grid_x, ...
        grid_y,raw_grid_trends,bc_type,idw_power,coordinate_system);
end
